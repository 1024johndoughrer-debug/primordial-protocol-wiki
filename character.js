const data={
"Fighter":{role:"SURVIVOR / FIGHTER",status:"ACTIVE",threat:"MODERATE",origin:"SECTOR 04",imageKey:"fighter",image:"assets/fighter.webp",summary:"A combat-capable survivor who refuses to become another name in the incident reports.",bio:"The Fighter was recovered from Sector 04 carrying equipment normally reserved for emergency response teams. Unlike most survivors, they chose to confront hostile entities rather than simply evade them. Their past remains partially sealed.",abilities:[{type:'PASSIVE',name:'Adrenaline Surge'},{type:'ABILITY',name:'Last Stand'}],note:"RUNNING only works until something faster finds you. So I learned to fight."},
"Unknown":{role:"KILLER / UNKNOWN",status:"UNKNOWN",threat:"CRITICAL",origin:"[NO RECORD]",imageKey:"unknown",image:"assets/unknown.webp",summary:"An unidentified organism whose name, origin, and purpose remain completely unknown.",bio:"No matching specimen exists in the official database. Witness descriptions are inconsistent, but every surviving report mentions the same unnerving behavior: it watches before it attacks.",abilities:[{type:'PASSIVE',name:'Something Is Watching'},{type:'ABILITY',name:'False Face'}],note:"There is no designation because there was never supposed to be anything alive down there."},
"Experiment 142":{role:"KILLER / EXPERIMENT",status:"ESCAPED",threat:"CRITICAL",origin:"EXPERIMENTAL WING",imageKey:"experiment142",image:"assets/experiment142.webp",summary:"Experiment 142 was created inside the Protocol's experimental wing. It was not the first attempt. It was the first one that escaped.",bio:"The original purpose of Experiment 142 has been heavily redacted. Containment records show repeated failures followed by an abrupt loss of all laboratory personnel. The creature's red-orange ocular glow became the primary visual identifier in later recovery reports.",abilities:[{type:'PASSIVE',name:'Adaptive Mutation'},{type:'ABILITY',name:'Neural Collapse'}],note:"142 IS NOT A NUMBER. IT IS A WARNING. — handwritten note recovered from the laboratory"},
"The Abyss":{role:"KILLER / ENTITY",status:"UNKNOWN",threat:"CRITICAL",origin:"BELOW SECTOR 04",imageKey:"abyss",image:"assets/abyss.webp",summary:"A shadowed entity associated with the disappearance of the lower-level teams.",bio:"There is no confirmed birth record, specimen record, or original designation. The name 'Abyss' first appears in handwritten notes recovered after Incident 0047. Every attempt to map its origin has ended with corrupted data.",abilities:[{type:'PASSIVE',name:'Void Presence'},{type:'ABILITY',name:'Abyssal Grasp'}],note:"DO NOT RESPOND TO VOICES FROM BELOW. THEY ARE NOT YOUR TEAM."},
...
if(d.image){ portraitImage.src=imgSrc(d.imageKey,d.image); portraitImage.alt=key+" portrait"; portrait.classList.add("has-image"); }
else { portraitImage.src=imgSrc("unknown","assets/unknown.webp"); portraitImage.alt="Redacted record"; portrait.classList.add("redacted-image"); }
const abilityIcon=imgSrc("ability-placeholder","assets/ability-placeholder.png");
